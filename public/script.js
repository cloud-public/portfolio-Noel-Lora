...
const translations = {
    en: {
        ...
        title: " Software Developer",
        aboutTitle: "About Me",
        aboutText: "I am a Software Engineer with strong experience in web development, systems administration, and networking, specialized in building modern, secure, and scalable applications using technologies such as React, Next.js, Node.js, and Linux-based environments. I have hands-on experience integrating authentication systems, APIs along with a solid background in networking, virtualization, and security-focused infrastructures. My knowledge of electronics and networking allows me to approach technical challenges from a holistic perspective, combining software and hardware expertise to deliver efficient, reliable, and real-world solutions.",
        skillsTitle: "Skills",
        ...
        footer: "© 2025 Noel Lora. All rights reserved.",
        formSending: "Sending...",
    ...
    es: {
        ...
        title: "Desarrollador de Software",
        aboutTitle: "Sobre Mí",
        aboutText: "Soy Ingeniero de Software con sólida experiencia en desarrollo web, administración de sistemas y redes, especializado en la creación de aplicaciones modernas, seguras y escalables utilizando tecnologías como React, Next.js, Node.js y entornos Linux. Cuento con experiencia práctica en la integración de sistemas de autenticación, APIs así como en infraestructuras orientadas a seguridad, virtualización y redes. Mi formación en electrónica y redes me permite abordar los retos técnicos desde una perspectiva integral, combinando software y hardware para ofrecer soluciones eficientes, confiables y de alto impacto en entornos reales.",
        ...
        footer: "© 2025 Noel Lora. Todos los derechos reservados.",
